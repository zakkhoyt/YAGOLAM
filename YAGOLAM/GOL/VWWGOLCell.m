...
//        color = [UIColor colorWithRed:red green:green blue:blue alpha:1.0];
        ...
        color = [NSColor colorWithCalibratedRed:(random()%100)/(float)100 green:(random()%100)/(float)100 blue:(random()%100)/(float)100 alpha:1];
...
-(NSString*)description{
    return [NSString stringWithFormat:@"%ld %ld %@", self.x, self.y, self.alive ? @"1" : @"0"];
}
