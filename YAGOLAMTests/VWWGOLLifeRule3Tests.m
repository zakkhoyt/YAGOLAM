...
#import "VWWGOLLifeRule3Tests.h"
#import "VWWGOLLIfe.h"

@interface VWWGOLLifeRule3Tests ()
...
- (void)testRule3a
{
    ...
    STAssertTrue([self.life cellPassesRule3:cell], @"failed to pass test for rule 3. %s", __func__);
    ...
    STAssertFalse([self.life cellPassesRule3:cell], @"failed to pass test for rule 3. %s", __func__);
}
