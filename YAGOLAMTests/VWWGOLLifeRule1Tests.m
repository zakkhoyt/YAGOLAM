...
#import "VWWGOLLifeRule1Tests.h"
#import "VWWGOLLife.h"


@interface VWWGOLLifeRule1Tests ()
@property (nonatomic, strong) VWWGOLLife *life;
@end

@implementation VWWGOLLifeRule1Tests
...
- (void)testRule1a
{
    ...
    STAssertFalse([self.life cellPassesRule1:cell], @"failed to pass test for rule 1. %s", __func__);
    ...
    STAssertTrue([self.life cellPassesRule1:cell], @"failed to pass test for rule 1. %s", __func__);
