...
#import "VWWGOLLifeRule2Tests.h"
#import "VWWGOLLIfe.h"

@interface VWWGOLLifeRule2Tests ()
...
- (void)testRule2a
{
    ...
    STAssertFalse([self.life cellPassesRule2:cell], @"failed to pass test for rule 2. %s", __func__);
    ...
    STAssertTrue([self.life cellPassesRule2:cell], @"failed to pass test for rule 2. %s", __func__);
