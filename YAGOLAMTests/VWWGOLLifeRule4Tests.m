...
#import "VWWGOLLifeRule4Tests.h"
#import "VWWGOLLIfe.h"

@interface VWWGOLLifeRule4Tests ()
...
- (void)testRule4a
{
    ...
    STAssertFalse([self.life cellPassesRule4:cell], @"failed to pass test for rule 4. %s", __func__);
    ...
    STAssertTrue([self.life cellPassesRule4:cell], @"failed to pass test for rule 4. %s", __func__);
